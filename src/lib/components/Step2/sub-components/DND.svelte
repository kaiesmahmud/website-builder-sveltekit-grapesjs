...
<div class="w-[100%] min-h-[70vh] max-w-[1500px]">
	<div class="w-[100%] flex flex-col items-center  justify-center gap-10 py-10 px-3">
		...
		<div class="w-[100%] flex items-center justify-center gap-5 font-semibold">
			<button class="bg-green-500/50 hover:bg-green-600 p-5 rounded  " on:click={handleEditNavbar}>Edit Navbar</button>
			<button class="bg-green-500/50 hover:bg-green-600 p-5 rounded  " on:click={handleEditNavbar}>Next Step</button>
		</div>
		{/if}
		{#if $editNavbar}
