...
<div class="p-5 md:px-8 mx-auto max-w-screen-xl">
    <div class="bg-white/80 text-gray-500 leading-7 font-['Merriweather'] text-sm p-2 mx-auto w-full flex flex-col md:flex-row gap-2 md:gap-5">
        <div id="main" class="flex flex-col">
            <div class="grid grid-flow-col py-2 md:py-5 text-xs md:text-base">
                ...
                <div class="flex flex-col">
                    <span class="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                            <path d="M5 21V5Q5 4.175 5.588 3.587Q6.175 3 7 3H17Q17.825 3 18.413 3.587Q19 4.175 19 5V21L12 18Z"></path></svg> <p class="px-2">Category</p>
                        </span> 
                ...
                <div class="flex flex-col my-8">
                    ...
                    <div class="bg-rose-400 h-1 w-10 rounded">
                    ...
                    <div id="profile" class="px-3 py-8 flex flex-col sm:flex-row gap-3">
                        ...
                        <div id="profile-data" class="w-full grid sm:ml-5">
                            <div id="bio" class="flex flex-row justify-between">
                                ...
                                <a href="/"><button class="pointer bg-amber-800 text-white font-bold py-2 px-7 hover:bg-amber-700">Follow</button></a>
                            </div> 
                            <div class="relative">
                                <input id="ch" type="checkbox" class="svelte-a9x181"> 
                                <label for="ch" id="ch-l" class="svelte-a9x181"></label> 
            ...
            <div class="p-7 pb-2 md:text-xs text-sm h-min bg-[#f1e9e5] flex flex-col min-w-[300px] md:max-w-xs mx-auto md:mx-4">
                <h2 class="md:text-lg text-xl uppercase text-amber-900 font-bold">Register, It's Free!</h2> 
                <div class="bg-rose-400 h-1 w-10 rounded"></div> 
                <p class="my-3 text-[11px]">It's time to take charge in this empowering workshop where you'll learn to focus on reclaiming
                your life and clearing out the obstacles ahead.</p> 
                <button class="w-full text-sm my-2 p-2 text-amber-800 bg-[#e4d1cc] hover:bg-[#f5bfb2]">
                    <span class="w-full grid grid-flow-col items-center justify-items-start font-semibold">
                        <svg fill="rgb(146, 64, 14)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="h-5 px-1">
                        ...
                        <p class="text-sm md:text-xs">Sign Up With Google</p>
                    </span>
                </button> 
                <button class="w-full text-sm my-2 p-2 text-amber-800 bg-[#e4d1cc] hover:bg-[#f5bfb2]">
                    <span class="w-full grid grid-flow-col items-center justify-items-start font-semibold">
                        ...
                        <p class="text-sm md:text-xs">Sign Up With Apple</p>
                    </span>
                </button> 
                <div class="my-4 relative">
                    <div class="absolute inset-0 flex items-center" aria-hidden="true">
                        <div class="w-full border-t border-amber-800">
    
                        </div>
                    </div> 
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-[#f1e9e5] text-amber-800">Or</span>
                    </div>
                </div> 
                <form>
                    <label class="text-amber-800">
                        <p class="font-bold">Email Address:</p> 
                        <input type="email" class="w-full p-2 my-2 outline-none border border-amber-800" required="">
                    </label> 
                    <button type="submit" class="pointer bg-amber-800 py-3 text-white w-full font-bold hover:bg-amber-700">CREATE ACCOUNT</button>
                </form>
            </div>
        </div>
